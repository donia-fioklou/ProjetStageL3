...
const LocalisationChart = ({ selectedZone, selectedCooperative }) => {
  ...
  function handleDownload() {
    ...
    const selectedFilter = document.getElementById('localisationFilter').value;
  
    if (selectedFilter === 'remplis') {
      convertJsonToExcel(remplisData, "localisation_remplis");
    } else if (selectedFilter === 'nonRemplis') {
      convertJsonToExcel(nonRemplisData, "localisation_non_remplis");
    } 
  }
